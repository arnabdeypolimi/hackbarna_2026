...
export const ListIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" {...base}><path d="M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01" /></svg>
);
export const SearchIcon = () => (
  <svg width="26" height="26" viewBox="0 0 24 24" aria-hidden="true" {...base}><circle cx="11" cy="11" r="7" /><path d="m20 20-3.5-3.5" /></svg>
);
...
export const Back10Icon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" {...base}><path d="M11 5 4 12l7 7M20 5l-7 7 7 7" /></svg>
);
export const Fwd10Icon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" {...base}><path d="m13 5 7 7-7 7M4 5l7 7-7 7" /></svg>
);
export const PlusIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" {...base}><path d="M12 5v14M5 12h14" /></svg>
);
export const PencilIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" {...base}><path d="M4 20h4L18.5 9.5a2.5 2.5 0 0 0-3.5-3.5L4 16.5V20z" /><path d="m13.5 7.5 3 3" /></svg>
);
export const CheckIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" {...base}><path d="m5 13 4 4L19 7" /></svg>
);
