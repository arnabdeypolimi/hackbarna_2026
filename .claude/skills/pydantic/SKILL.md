---
name: pydantic
description: Python data validation using type hints and runtime type checking with Pydantic v2's Rust-powered core for high-performance validation in FastAPI, Django, and configuration management. Use when working with API request/response validation, settings management, ORM model validation, data parsing and serialization, or type-safe data classes.
---
